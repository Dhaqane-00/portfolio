...
const userProps: User =
{
  ...
  aboutWork: 'I am currently working as a Fullstack Developer at Centro Educacional Interativo, where I am actively responsible for developing an application for employee maintenance and time registration for the company, aiming to create a friendly and functional interface.',
